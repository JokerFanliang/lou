...
<div id="dcMain"><!-- 当前位置 -->
    <div id="urHere">管理中心<b>></b><strong>类别</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3>
        <a href="<?php echo url('Type/add'); ?>" class="actionBtn">添加类别</a>好友类别
    </h3>
    <div class="filter">
        <form action="" method="get">
            <input name="name" class="input" type="text" value="" placeholder="按类型检索" />
