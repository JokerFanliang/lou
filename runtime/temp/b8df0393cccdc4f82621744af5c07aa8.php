...
<script type="text/javascript">
    ...
    function del(id) {
        layer.confirm('确定要删除吗？',  function(){
            window.location.href="/admin/Friends/del?id="+id;
        });
    }
</script>
<div id="dcMain"><!-- 当前位置 -->
    <div id="urHere">管理中心<b>></b><strong>通讯录</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3>
        <a href="<?php echo url('Friends/add'); ?>" class="actionBtn">添加好友</a>通讯录
    </h3>
    <div class="filter">
        <form action="" method="get">
            ...
            <input name="phone" class="input" type="text" value="" placeholder="按手机号检索" />
     ...
     <tr>
      ...
      <td align="center">
        <a href="<?php echo url('Friends/edit'); ?>?id=<?php echo $list->id; ?>">编辑</a> 
