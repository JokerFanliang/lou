...
<div id="dcMain"><!-- 当前位置 -->
    ...
    <h3>
        <a href="<?php echo url('Type/add'); ?>" class="actionBtn">添加类型</a>图书类型
    </h3>
    <div class="filter">
