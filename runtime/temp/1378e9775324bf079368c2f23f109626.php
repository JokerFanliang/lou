...
<div id="dcMain">
    ...
    <h3><a href="javascript:history.go(-1);" class="actionBtn">返回列表</a>添加学生</h3>
    <form action=""  method="post">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
            ...
            <tr>
                ...
                <td>
                    <input type="text" required="required" name="realname" size="40" class="inpMain" value="" />
                </td>
            </tr>
            <tr>
                <td width="100" align="right">学号</td>
                <td>
                    <input type="text" required="required" name="code" size="40" class="inpMain" value="" />
                </td>
            </tr>
            <tr>
                <td width="100" align="right">班级</td>
                <td>
                    <input type="text" required="required" name="class" size="40" class="inpMain" value="" />
                </td>
            </tr>
