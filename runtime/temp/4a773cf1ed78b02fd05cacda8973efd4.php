<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\phpStudy\PHPTutorial\WWW\lou/application/index\view\article\m_detail.html";i:1561900030;}*/ ?>
<!doctype html>
<html>
	...
	<body>
		...
		<div class="wrap">
			<div class="news_article">
				<h1><?php echo $article->title; ?></h1><span class="info_time"><?php echo $article->create_time; ?> <br/>来自:<?php echo $article->type->name; ?></span>
				<div id="ajax_all_page">
			...
			<div class="n_page_1">
				<div class="mk">
					...
					<div class="mk_middle lp_list yuan">
						...
						<a href="/index/article/detail?id=<?php echo $hot->id; ?>">
							<div class="loupan-item"><img src="<?php echo $hot->img; ?>">
								<ul>
									<li class="ui-name"><i><?php echo $hot->title; ?></i></li>
									<li class="fn-text-overflow"><?php echo $hot->create_time; ?></li>
								</ul>
							</div>
						</a>
						<?php endforeach; ?>
		...
		<div class="footer_new">
			...
			<p>全国统一服务热线 xx | 邮箱：cs@LouPan.com</p>
		...
		<!--bg e-->
		<!--share s-->
		<div class="share_contain" id="share_contain" style="top: 232.5px; display:none;">
			<div class="title">
				<h1 style="height:32px">分享到</h1><i class="closeBtn"></i></div>
			<div class="jiathis_style_32x32">
				<div>
					<a class="copyBtn" title="复制链接" href="javascript:copyToClipBoard();"></a>
					<a class="copyBtn descr" href="javascript:copyToClipBoard();" title="复制链接">复制链接</a>
				</div>
				<div>
					<a class="jiathis_button_qzone" title="分享到QQ空间" href="javascript:shareQzone();"><span class="jiathis_txt jtico jtico_qzone"></span></a>
					<a class="jiathis_button_qzone nobg" title="分享到QQ空间"><span class="jiathis_txt jiathis_separator jtico jtico_qzone">QQ空间</span></a>
				</div>
				<div>
					<a class="jiathis_button_tsina" title="分享到新浪微博" href="javascript:shareSina();"><span class="jiathis_txt jtico jtico_tsina"></span></a>
					<a class="jiathis_button_tsina nobg" title="分享到新浪微博"><span class="jiathis_txt jiathis_separator jtico jtico_tsina">新浪微博</span></a>
				</div>
				<div>
					<a class="jiathis_button_tqq" title="分享到腾讯微博" href="javascript:shareQQWeibo();"><span class="jiathis_txt jtico jtico_tqq"></span></a>
					<a class="jiathis_button_tqq nobg" title="分享到腾讯微博"><span class="jiathis_txt jiathis_separator jtico jtico_tqq">腾讯微博</span></a>
				</div>
				<div>
					<a class="jiathis_button_QQ" title="分享到QQ" href="javascript:shareQQ();"><span class="jiathis_txt jtico jtico_QQ"></span></a>
					<a class="jiathis_button_QQ nobg" title="分享到QQ"><span class="jiathis_txt jiathis_separator jtico jtico_QQ">QQ好友</span></a>
				</div>
			</div>
		</div>
		<!--share e-->
		<div id="show_url" style="display: none"><i class="closeBtn"></i> 请长按复制链接：
			<p id="fe_text" style=""></p>
		</div>
	</body>
