<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"D:\phpStudy\PHPTutorial\WWW\book\public/../application/admin\view\book\edit.html";i:1557663573;s:72:"D:\phpStudy\PHPTutorial\WWW\book\application\admin\view\public\head.html";i:1534821245;s:72:"D:\phpStudy\PHPTutorial\WWW\book\application\admin\view\public\left.html";i:1557629886;s:72:"D:\phpStudy\PHPTutorial\WWW\book\application\admin\view\public\foot.html";i:1534821326;}*/ ?>
...
<div id="dcMain">
    ...
    <h3><a href="javascript:history.go(-1);" class="actionBtn">返回列表</a>修改图书</h3>
    <form action=""  method="post" id="form"  enctype="multipart/form-data">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic" >
            <tr>
                ...
                <td>
                    <select name="type_id">
                        ...
                        <option value="<?php echo $list->id; ?>" <?php if($type->id==$list->type_id)echo 'selected';?>><?php echo $type->name; ?></option>
                        <?php endforeach; ?>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" required="required" name="name" size="40" class="inpMain name" value="<?php echo $list->name; ?>" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <img src="<?php echo $list->img; ?>" width="200px;">
                </td>
            </tr>
            <tr>
                <td width="100" align="right">价格</td>
                <td>
                    <input type="text" required="required" name="price" size="40" class="inpMain price" value="<?php echo $list->price; ?>" />
                </td>
            </tr>
            <tr>
                <td width="100" align="right">出版社</td>
                <td>
                    <input type="text" required="required" name="print" size="40" class="inpMain print" value="<?php echo $list->print; ?>" />
                </td>
            </tr>
            <tr>
                <td width="100" align="right">数量</td>
                <td>
                    <input type="text" required="required" name="num" size="40" class="inpMain num" value="<?php echo $list->num; ?>" />
                </td>
            </tr>
<!--             <tr>
            ...
            <tr>
                ...
                <td>
                    <textarea name="info" rows="5" cols="50"><?php echo $list->info; ?></textarea>
                </td>
            </tr>
            <tr>
                <td></td>
                <td>
                    ...
                    <input type="submit" class="btn" name="修改1">
