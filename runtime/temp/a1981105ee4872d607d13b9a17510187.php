<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"D:\phpStudy\PHPTutorial\WWW\book\public/../application/index\view\order\showmessage.html";i:1557671272;s:72:"D:\phpStudy\PHPTutorial\WWW\book\application\index\view\public\head.html";i:1557670971;}*/ ?>
<!DOCTYPE html>
<html>
			...
			<form action="" method="post" class="evaForm centerBox tac">
				...
				<div class="evaMainBox clear">
					...
					<div class="evaBox right">
						...
						<textarea name="message" readonly required rows="" cols="" id="evaluate"><?php echo $message->message; ?></textarea>
					</div>
					<?php if($message->replay): ?>
					<div class="evaBox right">
						<label class="regLab" for="evaluate">回复：</label>
						<input type="hidden" name="order_id" value="<?php echo $order->id; ?>">
						<textarea name="message" readonly required rows="" cols="" id="evaluate"><?php echo $message->replay; ?></textarea>
					</div>
					<?php endif; ?>
