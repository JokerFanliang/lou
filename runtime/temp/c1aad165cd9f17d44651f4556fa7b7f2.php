<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"D:\phpStudy\PHPTutorial\WWW\case4\public/../application/admin\view\type\index.html";i:1555913708;s:73:"D:\phpStudy\PHPTutorial\WWW\case4\application\admin\view\public\head.html";i:1534821245;s:73:"D:\phpStudy\PHPTutorial\WWW\case4\application\admin\view\public\left.html";i:1555913408;s:73:"D:\phpStudy\PHPTutorial\WWW\case4\application\admin\view\public\foot.html";i:1534821326;}*/ ?>
...
<div id="dcLeft">
    <div id="menu">
        ...
        <ul>
            <li><a href="/admin/Type/index"><i class="manager"></i><em>学院管理</em></a></li>
...
<script type="text/javascript">
    ...
    function del(id) {
        layer.confirm('确定要删除吗？',  function(){
            window.location.href="/admin/Type/del?id="+id;
        });
    }
</script>
<div id="dcMain"><!-- 当前位置 -->
    <div id="urHere">管理中心<b>></b><strong>学院</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3>
        <a href="<?php echo url('Type/add'); ?>" class="actionBtn">添加学院</a>学院列表
    </h3>
    <div class="filter">
        <form action="" method="get">
            <input name="name" class="input" type="text" value="" placeholder="按学院检索" />
     ...
     <tr>
      ...
      <td align="center">
        <a href="<?php echo url('Type/edit'); ?>?id=<?php echo $list->id; ?>">编辑</a> 
