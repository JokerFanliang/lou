...
<div id="dcMain">
    <!-- 当前位置 -->
    <div id="urHere">管理中心<b>></b><strong>成绩管理</strong> </div>   
    <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="javascript:history.go(-1);" class="actionBtn">返回列表</a>添加成绩</h3>
            ...
            <tr>
                ...
                <td>
                    <select name="student_id" required>
                        ...
                        <option value="<?php echo $student->id; ?>"><?php echo $student->code; ?></option>
                        <?php endforeach; ?>
                    </select>
                </td>
            </tr>
            <tr>
                <td width="100" align="right">成绩</td>
                <td>
                    <input type="text" required="required" name="grade" size="40" class="inpMain" value="" />
                </td>
            </tr>
