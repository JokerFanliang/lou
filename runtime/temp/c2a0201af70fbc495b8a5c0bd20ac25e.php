    ...
    <form action=""  method="post">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
            ...
            <tr>
                ...
                <td>
                    <input type="text" required="required" name="book" size="40" class="inpMain" value="<?php echo $list->book; ?>" />
                </td>
            </tr>
            <tr>
