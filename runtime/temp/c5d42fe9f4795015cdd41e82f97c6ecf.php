...
<script type="text/javascript">
    ...
    function del(id) {
        layer.confirm('确定要删除吗？',  function(){
            window.location.href="/admin/House/del?id="+id;
        });
    }
</script>
<div id="dcMain"><!-- 当前位置 -->
    ...
    <h3>
      <a href="/admin/House/add"  class="actionBtn">添加户型</a>
        户型列表
    </h3>
     ...
     <tr>
      ...
      <td align="center"><?php echo $list->house; ?></td>
      <td align="center">
        <img src="<?php echo $list->img; ?>" width="150px">
      </td>
      <td align="center"><?php echo $list->create_time; ?></td>
      <td align="center">
        <a href="<?php echo url('House/edit'); ?>?id=<?php echo $list->id; ?>">编辑</a> |
