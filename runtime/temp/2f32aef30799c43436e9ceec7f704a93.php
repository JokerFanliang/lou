...
<div id="dcMain">
    ...
    <h3><a href="javascript:history.go(-1);" class="actionBtn">返回列表</a>添加</h3>
    <form action=""  method="post">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
            ...
            <tr>
                ...
                <td>
                    <input type="text" required="required" name="phone" size="40" class="inpMain" value="" />
                </td>
            </tr>
            <tr>
                <td width="100" align="right">楼盘</td>
                <td>
                    <input type="text" required="required" name="build" size="40" class="inpMain" value="" />
                </td>
            </tr>
            <tr>
                <td></td>
