...
<script type="text/javascript">
    ...
    function del(id) {
        layer.confirm('确定要删除吗？',  function(){
            window.location.href="/admin/Img/del?id="+id;
        });
    }
</script>
<div id="dcMain"><!-- 当前位置 -->
    <div id="urHere">管理中心<b>></b><strong>楼盘图管理</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3>
      <a href="/admin/Img/add"  class="actionBtn">添加图</a>
        楼盘图列表
    </h3>
     ...
     <tr>
      ...
      <td align="center"><?php echo $list->build->name; ?></td>
      <td align="center">
        <img src="<?php echo $list->img; ?>" width="150px">
      </td>
      <td align="center"><?php echo $list->create_time; ?></td>
      <td align="center">
        <a href="<?php echo url('Img/edit'); ?>?id=<?php echo $list->id; ?>">编辑</a> |
