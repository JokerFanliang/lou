...
<script type="text/javascript">
    ...
    function del(id) {
        layer.confirm('确定要删除吗？',  function(){
            window.location.href="/admin/Subject/del?id="+id;
        });
    }
</script>
<div id="dcMain"><!-- 当前位置 -->
    <div id="urHere">管理中心<b>></b><strong>课程管理</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3>
        <a href="<?php echo url('Subject/add'); ?>" class="actionBtn">添加课程</a>课程列表
    </h3>
    <div class="filter">
        <form action="" method="get">
            <input name="name" class="input" type="text" value="" placeholder="按课程检索" />
     ...
     <tr>
      ...
      <td align="center">
        <a href="<?php echo url('Subject/edit'); ?>?id=<?php echo $list->id; ?>">编辑</a> 
