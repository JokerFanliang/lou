<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\phpStudy\PHPTutorial\WWW\lou/application/index\view\buildarticle\index.html";i:1561895998;s:71:"D:\phpStudy\PHPTutorial\WWW\lou\application\index\view\public\head.html";i:1561876054;}*/ ?>
<!doctype html>
<html lang="zh-cn">
 <head>
  <meta charset="UTF-8">
  ...
  <meta name="mobile-agent" content="format=html5; url=http://m.loupan.com/gz/loupan/7031803/dongtai/">
  <meta name="mobile-agent" content="format=xhtml; url=http://m.loupan.com/gz/loupan/7031803/dongtai/">
  <link rel="alternate" media="only screen and(max-width: 640px)" href="/public/static/index/pc/css/null_7da48f73ee384eac803a9582a9e6004d.">
 ...
 <body>
  ...
  <div class="pages">
   <div class="pages pages-house pages-dtlb">
      ...
      <div class="list-dt">
       <ul id="load-timer">
        ...
        <li>
         ...
         <div class="t">
          <a href="/index/buildarticle/detail?id=<?php echo $article->id; ?>" target="_blank"> <?php echo $article->title; ?></a>
         </div>
        <?php
         ...
         <div class="desc">
           <?php echo $content; ?>...... 
          <a href="/index/buildarticle/detail?id=<?php echo $article->id; ?>" target="_blank">查看详细 &gt;&gt;</a>
         </div>
       </li>
        <?php endforeach; ?>
       </ul>
<!--        <div class="more">
        <a href="javascript:void(0);" house-id="7031803" data-type="" data-i="2">显示更多 &gt;&gt;</a>
       </div> -->
      </div>
      <!-- 订阅本盘 -->
     ...
     <div class="house-right">
      ...
      <div class="priceEqual">
       <div class="tit">
        <h5>热门楼盘</h5>
        <a href="http://gz.loupan.com/xinfang/nansha/">查看更多 &gt;&gt;</a>
       </div>
       <ul>
        <?php foreach($hot_builds as $key=>$hot): ?>
        <li><a href="/index/build/index" target="_blank"><span><?php echo $key+1; ?></span><p><?php echo $hot->name; ?></p><p><?php echo $hot->start_price; ?></p><i><?php echo $hot->position->position; ?></i></a></li>
        <?php endforeach; ?>
       </ul>
      </div>
     </div>
   ...
   <div class="feedback">
    ...
    <div class="panel">
     ...
     <form action="/about/sug" method="post" id="feedbackform">
      ...
      <input name="backurl" type="hidden" value="/dongtai/7031803.html">
      <div class="textarea">
