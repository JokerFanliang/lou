<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\phpStudy\PHPTutorial\WWW\lou/application/index\view\build\m_image.html";i:1561902348;}*/ ?>
<!doctype html>
<html lang="zh-cn">
 <head> 
  <meta charset="UTF-8"> 
  ...
  <link rel="canonical" href="/public/static/index/mobile/css/list-7031803.html"> 
  <!-- 此js必须在head标签里面 --> 
 ...
 <body> 
  ...
  <!--   <span></span>  -->
   ...
   <!-- 楼盘相册 --> 
<!--    <div class="choose"> 
    <div data-num="5" class="item active">
     实景图
    </div> 
    <div data-num="12" class="item ">
     样板间
    </div> 
    <div data-num="1" class="item ">
     配套图
    </div> 
    <div data-num="32" class="item ">
     效果图
    </div> 
    <div data-num="1" class="item ">
     位置图
   ...
   <div class="swiper-container photos"> 
    <div class="swiper-wrapper"> 
     ...
     <div class="swiper-slide" data-group="0"> 
  ...
  <div class="footFloat"> 
   ...
   <a rel="nofollow" href="javascript:" class="test-enter item" data-id="24994" data-site_id="34" data-house_id="7031803" data-need_idcard="0" data-title="预约看房" data-loupan="越秀滨海新城"> <p class="item-bnzf">预约看房</p> </a> 
  ...
  <script src="/public/static/index/mobile/js/require.js" data-main="http://public.loupan.com/public/assets_v4_m/js/house/house_xc.js?ver=201905281638"></script> 
  <!-- baidu熊掌号 --> 
