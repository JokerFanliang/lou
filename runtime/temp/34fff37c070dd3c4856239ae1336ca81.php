<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\phpStudy\PHPTutorial\WWW\lou/application/index\view\buildtype\m_index.html";i:1561903972;}*/ ?>
<!doctype html>
<html lang="zh-cn">
 <head> 
  <meta charset="UTF-8"> 
  ...
  <link rel="canonical" href="/public/static/index/mobile/css/list-7031803_179c11778dde4487bd03c27b4a83f7ec.html"> 
  <!-- 此js必须在head标签里面 --> 
...
<!--      <a href="javascript:;" class="menu" id="showMenu"></a>  -->
    ...
    <div class="list">
     ...
     <a href="/index/buildtype/detail?id=<?php echo $house->id; ?>" class="item"> 
      ...
      <div class="text"> 
       ...
       <div class="size">
        建面：
        <span><?php echo $house->build_s; ?></span>
       </div> 
      </div> 
     </a> 
     <?php endforeach; ?>
  ...
  <div class="footFloat"> 
   ...
   <a rel="nofollow" href="javascript:" class="test-enter item" data-id="24996" data-site_id="34" data-house_id="7031803" data-need_idcard="0" data-title="预约看房" data-loupan="越秀滨海新城"> <p class="item-bnzf">预约看房</p> </a> 
