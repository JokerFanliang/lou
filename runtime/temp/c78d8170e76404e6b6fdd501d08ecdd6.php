            ...
            <tr>
                ...
                <td>
                    <select name="type_id">
                        ...
                        <option value="<?php echo $type->id; ?>" <?php if($type->id==$list->type_id) echo "selected";?>><?php echo $type->name; ?></option>
                        <?php endforeach; ?>
                    </select>
                </td>
            </tr>
