<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"D:\phpStudy\PHPTutorial\WWW\book\public/../application/admin\view\order\index.html";i:1557628725;s:72:"D:\phpStudy\PHPTutorial\WWW\book\application\admin\view\public\head.html";i:1534821245;s:72:"D:\phpStudy\PHPTutorial\WWW\book\application\admin\view\public\left.html";i:1557629886;s:72:"D:\phpStudy\PHPTutorial\WWW\book\application\admin\view\public\foot.html";i:1534821326;}*/ ?>
...
<div id="dcMain"><!-- 当前位置 -->
    <div id="urHere">管理中心<b>></b><strong>订单管理</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3>
        订单列表
    </h3>
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
     <tr>
      ...
      <td align="center"><?php echo $list->type==1?"已付款" : "货到付款"; ?></td>
      <td align="center"><?php echo $list->state==0?"待发货" : ($list->state==1 ? "已发货" : "已收货"); ?></td>
      <td align="center"><?php echo $list->create_time; ?></td>
      <td align="center">
        <a href="<?php echo url('Order/edit'); ?>?id=<?php echo $list->id; ?>">编辑</a> 
