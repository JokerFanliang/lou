<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"D:\phpStudy\PHPTutorial\WWW\book\public/../application/admin\view\user\edit.html";i:1557623773;s:72:"D:\phpStudy\PHPTutorial\WWW\book\application\admin\view\public\head.html";i:1534821245;s:72:"D:\phpStudy\PHPTutorial\WWW\book\application\admin\view\public\left.html";i:1557475653;s:72:"D:\phpStudy\PHPTutorial\WWW\book\application\admin\view\public\foot.html";i:1534821326;}*/ ?>
...
<div id="dcLeft">
    <div id="menu">
        ...
        <ul>
            <li><a href="/admin/Order/index"><i class="manager"></i><em>评价管理</em></a></li>
        </ul>
    ...
    <form action=""  method="post" id="form"  enctype="multipart/form-data">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic" >
            ...
            <tr>
                ...
                <td>
                    <input type="text"  name="realname" size="40" class="inpMain title" value="<?php echo $list->realname; ?>" />
                </td>
            </tr>
            <tr>
                <td width="100" align="right">手机号</td>
                <td>
                    <input type="text"  name="phone" size="40" class="inpMain title" value="<?php echo $list->phone; ?>" />
                </td>
            </tr>
            <tr>
                <td width="100" align="right">地址</td>
                <td>
                    <input type="text"  name="address" size="40" class="inpMain title" value="<?php echo $list->address; ?>" />
                </td>
            </tr>
            <tr>
                <td></td>
                <td>
                    ...
                    <input type="submit" class="btn sub" value="修改" >
                </td>
            </tr>
        </table>
    </form>
