<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"D:\phpStudy\PHPTutorial\WWW\lou/application/admin\view\buildarticle\edit.html";i:1561046123;s:71:"D:\phpStudy\PHPTutorial\WWW\lou\application\admin\view\public\head.html";i:1560266739;s:71:"D:\phpStudy\PHPTutorial\WWW\lou\application\admin\view\public\left.html";i:1561045570;s:71:"D:\phpStudy\PHPTutorial\WWW\lou\application\admin\view\public\foot.html";i:1534821326;}*/ ?>
...
<div id="dcLeft">
    <div id="menu">
        ...
        <ul>
            ...
            <li><a href="/admin/Buildarticle/index"><i class="manager"></i><em>楼盘动态</em></a></li>
        </ul>
    ...
    <form action=""  method="post" id="form" enctype="multipart/form-data">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                ...
                <td>
                    <select name="build_id">
                        <?php foreach($builds as $build): ?>
                            <option value="<?php echo $build->id; ?>" <?php if($list->build_id==$build->id)echo 'selected';?>><?php echo $build->name; ?></option>
                        <?php endforeach; ?>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" required name="title" size="40" class="inpMain" value="<?php echo $list->title; ?>" />
                </td>
            </tr>
            <tr>
