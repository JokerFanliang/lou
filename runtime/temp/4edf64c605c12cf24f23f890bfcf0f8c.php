<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\phpStudy\PHPTutorial\WWW\lou/application/index\view\build\image.html";i:1561893713;s:71:"D:\phpStudy\PHPTutorial\WWW\lou\application\index\view\public\head.html";i:1561876054;}*/ ?>
<!doctype html>
<html lang="zh-cn">
 <head>
  <meta charset="UTF-8">
  ...
  <meta name="mobile-agent" content="format=html5; url=http://m.loupan.com/gz/loupan/7031803/xiangce">
  <meta name="mobile-agent" content="format=xhtml; url=http://m.loupan.com/gz/loupan/7031803/xiangce">
  <link rel="alternate" media="only screen and(max-width: 640px)" href="/public/static/index/pc/css/xiangce">
  <title>广州越秀滨海新城相册_户型图_实景图-广州楼盘网</title>
  <meta name="Keywords" content="越秀滨海新城相册,越秀滨海新城户型图,越秀滨海新城实景图">
  <meta name="description" content="广州楼盘网提供全套越秀滨海新城楼盘相册,包括户型图,实景图,外景图,样板房图,规划图,配套图,交通图等越秀滨海新城楼盘图片。">
 ...
 <body>
  ...
  <div class="pages">
   <div class="pages pages-house pages-hx">
    ...
    <div class="container box">
     <div class="house-left">
      ...
      <div class="xclb">
       <div class="tit">
        <p>楼盘相册</p>
<!--         <a href="http://gz.loupan.com/photo/7031803/tu4-2319575.html">高清大图</a> -->
       </div>
       <ul>
        <?php foreach($imgs as $img): ?>
        <li><a href="<?php echo $img->img; ?>" target="blank" class="img"><img src="<?php echo $img->img; ?>" alt=""></a>
         <div class="text">
          <div class="txt"></div>
         </div>
       </li>
...
<!--        <div class="page-turn">
        <div class="item-turn">
         <a href="/photo/list-7031803.html" class="z-crt">1</a>
         <a href="/photo/list-7031803-p2.html" class="">2</a>
         <a href="/photo/list-7031803-p3.html" class="">3</a>
         <a href="/photo/list-7031803-p4.html" class="">4</a>
         <a href="/photo/list-7031803-p5.html" class="">5</a>
         <a href="/photo/list-7031803-p2.html" class="pagenxt">下一页</a>
        </div>
       </div> -->
      </div>
      <!-- 为您推荐 -->
     ...
     <div class="house-right">
      <div class="hx-nav">
       <ul>
        <li><a href="http://gz.loupan.com/photo/list-7031803-1.html" class="item item-xgt"><p>楼盘图</p><span>32</span></a></li>
       </ul>
       <div class="price">
        <p>参考价格： <span><?php echo $build->start_price; ?></span></p>
       </div>
       <div class="txt">
        最新开盘： <?php echo $build->start_time; ?>
       </div>
       <div class="txt">
        楼盘地址：<?php echo $build->address; ?>
       </div>
       <div class="txt">
        主力户型：<?php echo $build->housetype->name; ?> 
       </div>
      </div>
      <!-- 订阅信息 -->
...
<!--     <div class="mianze box">
   ...
   <div class="feedback">
    ...
    <div class="panel">
     ...
     <form action="/about/sug" method="post" id="feedbackform">
      ...
      <input name="backurl" type="hidden" value="/photo/list-7031803.html">
      <div class="textarea">
  ...
  <script type="text/javascript"> var _href = window.location.href; if (_href.indexOf('?') != -1) { _href = _href.substr(0 ,_href.indexOf('?')); } var _chat = [{c:1,d:12,e:_href,f:"34",g:"62",h:"7031803",i:"1",j:""},{data:{type:12,name:"越秀滨海新城",img:"http://static.loupan.com/upfile2/image/20180813/20180813140930_5476201.jpg",areaRoom:"南沙",price:"参考起价：19000元/㎡",fromUrl:_href},desc:"客户给你发了一条楼盘信息",ext:""}]; (function () { var _im = document.createElement('script'); _im.type = 'text/javascript'; _im.async = true; _im.src = 'http://tools.loupan.com/chat/chat.js?v=201906111346'; var _imm = document.getElementsByTagName('script')[0]; _imm.parentNode.insertBefore(_im, _imm); })(); </script>
