...
<div id="dcMain">
    ...
    <h3><a href="javascript:history.go(-1);" class="actionBtn">返回列表</a>修改位置</h3>
    <form action=""  method="post">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
            <tr>
                <td width="100" align="right">位置</td>
                <td>
                    <input type="text" required="required" name="position" size="40" class="inpMain" value="<?php echo $list->position; ?>" />
                </td>
            </tr>
            <tr>
                <td></td>
