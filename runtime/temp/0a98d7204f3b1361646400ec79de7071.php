    ...
    <form action=""  method="post" id="form" enctype="multipart/form-data">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
            ...
            <tr>
                ...
                <td>
                    <input type="text" required name="house" size="40" class="inpMain" value="<?php echo $list->house; ?>" />
                </td>
            </tr>
            <tr>
                <td align="right">建筑面积</td>
                <td>
                    <input type="text" required name="build_s" size="40" class="inpMain" value="<?php echo $list->build_s; ?>" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <img width="200px" src="<?php echo $list->img; ?>">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <script id="editor" type="text/plain" style="width:1024px;height:300px;"><?php echo $list->desc; ?></script>
                </td>
            </tr>
