...
<script type="text/javascript">
    ...
    function del(id) {
        layer.confirm('确定要删除吗？',  function(){
            window.location.href="/admin/Buildarticle/del?id="+id;
        });
    }
</script>
<div id="dcMain"><!-- 当前位置 -->
    ...
    <h3>
      <a href="/admin/Buildarticle/add"  class="actionBtn">添加动态</a>
        动态列表
    </h3>
     ...
     <tr>
      ...
      <td align="center">
        <a href="<?php echo url('Buildarticle/edit'); ?>?id=<?php echo $list->id; ?>">编辑</a> |
