...
<script type="text/javascript">
    ...
    function del(id) {
        layer.confirm('确定要删除吗？',  function(){
            window.location.href="/admin/articletype/del?id="+id;
        });
    }
</script>
<div id="dcMain"><!-- 当前位置 -->
    <div id="urHere">管理中心<b>></b><strong>楼讯类型</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3>
        <a href="<?php echo url('Articletype/add'); ?>" class="actionBtn">添加类型</a>类型列表
    </h3>
     ...
     <tr>
      ...
      <td align="center">
        <a href="<?php echo url('Articletype/edit'); ?>?id=<?php echo $list->id; ?>">编辑</a> 
