<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"D:\phpStudy\PHPTutorial\WWW\card\public/../application/admin\view\user\index.html";i:1557392029;s:72:"D:\phpStudy\PHPTutorial\WWW\card\application\admin\view\public\head.html";i:1534821245;s:72:"D:\phpStudy\PHPTutorial\WWW\card\application\admin\view\public\left.html";i:1557393332;s:72:"D:\phpStudy\PHPTutorial\WWW\card\application\admin\view\public\foot.html";i:1534821326;}*/ ?>
...
<div id="dcLeft">
    <div id="menu">
        ...
        <ul>
            ...
            <li><a href="/admin/Card/index"><i class="manager"></i><em>地铁卡管理</em></a></li>
            <li><a href="/admin/Record/index"><i class="manager"></i><em>充值记录</em></a></li>
            <li><a href="/admin/Record/index"><i class="manager"></i><em>路线管理</em></a></li>
            <li><a href="/admin/Record/index"><i class="manager"></i><em>购票记录</em></a></li>
...
<div id="dcMain"><!-- 当前位置 -->
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
        ...
        <tr>
            ...
            <td align="center"><?php echo $list->is_vip==0?"否" : ($list->is_vip==1 ? "待审核" : ($list->is_vip==2 ? "审核通过" : "审核未通过")); ?></td>
            <td align="center"><?php echo $list->create_time; ?></td>
            <td align="center">
                <a href="<?php echo url('User/edit'); ?>?id=<?php echo $list->id; ?>">编辑</a> 
            </td>
        </tr>
