...
<script type="text/javascript">
    ...
    function del(id) {
        layer.confirm('确定要删除吗？',  function(){
            window.location.href="/admin/banner/del?id="+id;
        });
    }
</script>
<div id="dcMain"><!-- 当前位置 -->
    <div id="urHere">管理中心<b>></b><strong>Banner管理</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3>
      <a href="/admin/banner/add"  class="actionBtn">添加banner</a>
        banner列表
    </h3>
     ...
     <tr>
      ...
      <td align="center">
        <img src="<?php echo $list->img; ?>" width="150px">
      </td>
      <td align="center"><?php echo $list->create_time; ?></td>
      <td align="center">
        <a href="<?php echo url('Banner/edit'); ?>?id=<?php echo $list->id; ?>">编辑</a> |
